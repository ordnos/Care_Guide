    ...
    <section>
        ...
        <div class="row py-5">
                ...
                <div class="col-md-6 justify-content-center">
                    <img class="w-100 d-sm-none d-md-block d-none d-sm-block d-md-none d-lg-block" src="https://i.ibb.co/yQWJBrQ/socia-girl.png">
                </div>
            </div>
    </div>
    </section>
        ...
        <div class="container position-relative py-md-5 py-0">
            <div class="row">
                <div class="col-lg-8 offset-lg-2 text-center">
                    ...
                    <p class="f-16 mb-5 text-cg">I am text block. Click edit button to change this text. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.</p>
