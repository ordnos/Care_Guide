        ...
        <div class="row py-5">
            ...
            <div class="col-md-6 title-cg">
                    ...
                    <div class="row justify-content-initial">
                        ...
                        <!-- Texto -->
                        <p class="h6 mt-3 ml-3 text-cg ">Encontre referencias de pessoas que 
            ...
            <div class="col-md-6 justify-content-center">
                ...
                src="https://i.ibb.co/yQWJBrQ/socia-girl.png">
            </div>
...
<section class="boot-elemant-bg py-md-5 py-4 mt-5 d-none">
    <div class="container position-relative py-md-5 py-0">
        <div class="row">
            <div class="col-lg-8 offset-lg-2 text-center">
                
                <!-- Texto -->
                <span class="text-uppercase text-cg">Video</span>      
                <h2 class="font-weight-bold title-cg">Um pouco sobre a visão deste mundo.</h2> 
                <p class="f-16 mb-5 text-cg">I am text block. Click edit button to change this text. 
...
<!-- Inicio da Sessão sobre "o que é a CareGuide" -->
...
<!-- Fim da Sessão sobre "o que é a CareGuide" -->

<!-- Inicio do Espaçador -->
<div class="medium-spacing d-sm-none d-md-block d-none d-sm-block d-md-none d-lg-block"></div>
<!-- Fim do Espaçador -->

<!-- Inicio da Sessão de Explicação -->
    ...
    <div class="container py-5">
        <div class="row py-5">
            ...
            <div class="col-md-6 mt-5">
                <p class="h5 text-center mt-5 text-cg">Nosso projeto foca em auxiliar na prevenção e combate 
